...
import { FiCamera, FiTag, FiClock } from 'react-icons/fi'
    ...
    <div className="flex flex-col gap-6 pb-8">
      ...
      <header className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 rounded-2xl bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-transparent p-6 border border-emerald-500/20 dark:from-emerald-500/20 dark:via-teal-500/10 dark:border-emerald-500/30 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Net Worth Snapshots</h1>
                ...
                <tr>
                  <td className="px-5 py-10 text-center text-slate-500" colSpan={5}>
                    <div className="flex flex-col items-center justify-center gap-2">
                      ...
                      <p>No snapshots taken yet. Capture your current portfolio to start your history.</p>
                    </div>
                  </td>
                </tr>
              ) : (
